...
| `tool_plan_queue` | array | 0AI/0AJ/0AK/0AL | Persistent reviewable governed tool plans; planning, review, step-proposal queueing, and plan execution requests remain governed and non-autonomous. |
