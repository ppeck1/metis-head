...
| `tool_plan_queue` | array | 0AI | Persistent reviewable governed tool plans; planning does not execute tools. |
...
| `metis_head.tool_task_planner` | 0AH | Deterministically turns broad task requests into reviewable non-executing tool plans. |
