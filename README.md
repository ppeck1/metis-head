...
current review target. The governed tools track is `100%` complete for the current
simulation-first governed tool substrate. Live fetch, BOH-as-tool, Atlas/tool adapters, filesystem
write lanes, arbitrary git commands, shell execution, hardware actions, external mutation lanes, and
autonomous execution remain future-phase work by design.
