...
simulation-first scope. Practical tool-using task requests are about `45%` complete: Metis can plan
multi-step governed tool tasks and execute narrow reviewed read-only lanes, but cannot yet run
