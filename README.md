...
simulation-first scope. Practical tool-using task requests are about `52%` complete: Metis can plan
multi-step governed tool tasks, persist and review them, and execute narrow reviewed read-only lanes, but cannot yet run
