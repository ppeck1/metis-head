...
- Added `Voice Trace` dashboard panel below Virtual Chat.
- Added `safeVoiceTraceEvents()` and `renderVoiceTrace()` dashboard helpers.
- The trace displays command vs confirmation events, status, proposal ID, redaction status,
